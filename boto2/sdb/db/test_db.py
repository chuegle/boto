...
from boto2.sdb.db.property import StringProperty, IntegerProperty, BooleanProperty
from boto2.sdb.db.property import DateTimeProperty, FloatProperty, ReferenceProperty
from boto2.sdb.db.property import PasswordProperty, ListProperty, MapProperty
from datetime import datetime
import time
from boto2.exception import SDBPersistenceError

_objects = {}

#
# This will eventually be moved to the boto2.tests module and become a real unit test
