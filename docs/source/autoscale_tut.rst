...
>>> ec2 = boto1.connect_autoscale(host='eu-west-1.autoscaling.amazonaws.com')

Alternatively, edit your boto1.cfg with the default Autoscale endpoint to use::
...
>>> from boto1.ec2.autoscale import LaunchConfiguration
>>> from boto1.ec2.autoscale import AutoScalingGroup
...
>>> from boto1.ec2.autoscale import Trigger
