...
class AWSQueryService(boto2.connection.AWSQueryConnection):
    ...
    def __init__(self, **args):
        ...
        try:
            boto2.connection.AWSQueryConnection.__init__(self, **self.args)
            self.aws_response = None
        except boto2.exception.NoAuthHandlerFound:
