"""Object-oriented interface to SWF wrapping boto2.swf.layer1.Layer1"""
...
class Domain(SWFBase):
    ...
    def executions(self, closed=False, **kwargs):
        ...
        For more info, try:
        >>> help(boto2.swf.layer1.Layer1.list_closed_workflow_executions)
        >>> help(boto2.swf.layer1.Layer1.list_open_workflow_executions)
        """
        if closed:
